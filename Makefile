...
help:
	...
	@echo "  all           Run format, lint, test, and notebooks"
...
lint:
	...
	@echo "- flake8..."
	python -m flake8 alteruphono/ --max-line-length=88 --extend-ignore=E203,W503
	@echo "- mypy..."
	python -m mypy alteruphono/ --ignore-missing-imports || true

format:
	@echo "Formatting code..."
	@echo "- black..."
	python -m black alteruphono/ examples/ tests/ --line-length=88
	@echo "- isort..."
	python -m isort alteruphono/ examples/ tests/ --profile=black

# Notebook targets
notebooks:
	@echo "Executing all notebooks in examples/ directory..."
	@echo "This will populate output cells for GitHub display."
	@echo "This ensures that Jupyter notebooks show outputs directly on GitHub"
	@echo "without requiring users to run them locally."
	@if [ ! -d "examples" ]; then \
...
# Comprehensive check
all: format lint test notebooks
	@echo ""
